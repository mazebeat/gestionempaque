...
$MONGO["servers"][$i]["mongo_db"] = "gestionempaques";//default mongo db to connect, works only if mongo_auth=false
$MONGO["servers"][$i]["mongo_user"] = "root";//mongo authentication user name, works only if mongo_auth=false
$MONGO["servers"][$i]["mongo_pass"] = "SNT.GestionEmpaques123";//mongo authentication password, works only if mongo_auth=false
