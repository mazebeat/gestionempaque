$(document).ready(function(){var a=new GMaps({el:"#map",lat:-33.44218866018473,lng:-70.65383811528318});a.addMarker({lat:-33.44218866018473,lng:-70.65383811528318,title:"La Moneda"})});(function(a,b){if(typeof exports==="object"){module.exports=b()}else{if(typeof define==="function"&&define.amd){define("GMaps",[],b)}}a.GMaps=b()}(this,function(){
/*!
 * GMaps.js v0.4.17
