$(function () {
    ...
    function draw5() {
        ...
        var myDoughnut2 = new Chart(document.getElementById("doughnut-chart2").getContext("2d")).Doughnut(doughnutData);
        var myDoughnut3 = new Chart(document.getElementById("doughnut-chart3").getContext("2d")).Doughnut(doughnutData);
        var myDoughnut4 = new Chart(document.getElementById("doughnut-chart4").getContext("2d")).Doughnut(doughnutData);
    }
