...
{{ Form::model($planilla, array('class' => 'form-horizontal', 'method' => 'PATCH', 'route' => array('planillas.update', $planilla->id))) }}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
      ...
      {{ link_to_route('planillas.show', 'Cancel', $planilla->id, array('class' => 'btn btn-lg btn-default')) }}
    </div>
</div>
