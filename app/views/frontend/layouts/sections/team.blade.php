<div class="row">
    ...
    <div class="text-center">
        <h3 class="border-danger"><span class="heading_border bg-danger">Nuestro Equipo</span></h3>
    </div>
    ...
    <div class="col-md-3 col-sm-5 col-xs-10 profile">
        <div class="thumbnail bg-white  text-center">
            <img src="{{ asset('frontend/images/img_3.jpg') }}" alt="team-image" class="img-responsive">
    ...
    <div class="col-md-3 col-sm-5 col-xs-10 profile">
        <div class="thumbnail bg-white text-center">
            <img src="{{ asset('frontend/images/img_5.jpg') }}" alt="team-image">
    ...
    <div class="col-md-3 col-sm-5 col-xs-10 profile">
        <div class="thumbnail bg-white  text-center">
            <img src="{{ asset('frontend/images/img_4.jpg') }}" alt="team-image" class="img-responsive">
    ...
    <div class="col-md-3 col-sm-5 col-xs-10 profile">
        <div class="thumbnail bg-white text-center">
            <img src="{{ asset('frontend/images/img_6.jpg') }}" alt="team-image">
