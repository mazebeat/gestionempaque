<ul class="list-inline">
    <li>
        <ul class="list-inline icon-position">
            ...
            @if(Sentry::check())
                <li>
                    <label class="hidden-xs text-white">{{ Sentry::getUser()->first_name }} {{ Sentry::getUser()->last_name }} <a href="{{ url('logout') }}" class="btn-link text-white"><i class="fa fa-hand-spock-o" aria-hidden="true"></i> LogOut!</a></label>
                </li>
            @endif
        </ul>
    </li>
    ...
    <li class="pull-right">
        <ul class="list-inline">
            <li>
                <a href="{{ url('') }}"><img src="{{ asset('frontend/images/logo.png') }}" class="logo_position" style="width: 145px;" /></a>
            </li>
            <li>
