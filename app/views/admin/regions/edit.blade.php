...
@section('main')
    ...
    {{ Form::model($region, array('class' => 'form-horizontal', 'method' => 'PATCH', 'route' => array('admin.regions.update', $region->id))) }}
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            ...
            {{ link_to_route('admin.regions.show', 'Cancel', $region->id, array('class' => 'btn btn-lg btn-default')) }}
        </div>
    </div>
