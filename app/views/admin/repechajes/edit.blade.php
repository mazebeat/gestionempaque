...
@section('main')
    ...
    {{ Form::model($repechaje, array('class' => 'form-horizontal', 'method' => 'PATCH', 'route' => array('admin.repechajes.update', $repechaje->id))) }}
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            ...
            {{ link_to_route('admin.repechajes.show', 'Cancel', $repechaje->id, array('class' => 'btn btn-lg btn-default')) }}
        </div>
    </div>
