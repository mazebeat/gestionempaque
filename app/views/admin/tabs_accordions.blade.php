            ...
            <div class="col-md-6">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="livicon" data-name="printer" data-size="16" data-loop="true"
                            ...
                            <div id="myTabContent" class="tab-content">
                                ...
                                <div class="tab-pane fade" id="dropdown1">
                                    <p>
                                        ...
                                        skateboard locavore carles etsy salvia banksy hoodie helvetica. DIY synth PBR
                                        banksy irony. Leggings gentrify squid 8-bit cred pitchfork.Raw denim you
                                        ...
                                        cardigan american apparel, butcher voluptate nisi qui.Raw denim you probably
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="livicon" data-name="sort" data-size="16" data-loop="true" data-c="#fff"
                               data-hc="white"></i>
                            Popover
                        </h3>
                    <span class="pull-right clickable">
                    ...
                    <div class="panel-body">
                        ...
                        <span class="bs-example tooltip-demo">
                            <button class="btn tooltips btn-warning btn-lg" data-toggle="tooltip" data-tooltip="tooltip"
                                    ...
                                    style="margin-bottom:10px;">Bottom</button>
                        </span>
                        </p>
                        <div class="bs-example">
                                ...
                                <div class="po-content hidden">
                                    ...
                                    <div class="po-body">
                                        <p>
                                            ...
                                            sports worldwide is <strong>association football</strong>
