                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="livicon" data-name="vector-circle" data-size="16" data-loop="true" data-c="#000"
                               data-hc="#000"></i>
                            Circular Charts
                        </h3>
...
@section('footer_scripts')
    ...
    <script src="{{ asset('assets/vendors/animationcharts/jquery.flot.animator.min.js') }}"
            type="text/javascript"></script>
    <script src="{{ asset('assets/vendors/charts/circliful/jquery.circliful.min.js') }}"></script>
    <script src="{{ asset('assets/vendors/charts/jquery.flot.resize.js') }}" language="javascript"
            type="text/javascript"></script>
