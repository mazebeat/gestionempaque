...
<head>
    <title>Administrador | Gestión Empaques</title>
                    ...
                    <div id="login" class="animate form">
                        <form action="{{ route('signin') }}" autocomplete="on" method="post" role="form">
                            ...
                            <p class="keeplogin">
                                ...
                                <label for="remember-me">{{ \Lang::get('button.rememberme') }}</label>
                            </p>

                            <p class="login button">
                                <input type="submit" value="{{ \Lang::get('button.signin') }}" class="btn btn-success"/>
                            </p>
