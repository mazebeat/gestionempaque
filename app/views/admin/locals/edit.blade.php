...
@section('main')
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            {{ Form::input('number', 'telefono', Input::old('telefono'), array('class'=>'form-control', 'placeholder'=>'Telefono')) }}
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            ...
            {{ link_to_route('admin.locals.show', 'Cancel', $local->id, array('class' => 'btn btn-lg btn-default')) }}
        </div>
    </div>
