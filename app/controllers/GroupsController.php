	...
	public function postCreate()
	{
		...
		try {
			...
			if ($group = Sentry::getGroupProvider()->create($inputs)) {
				...
				return Redirect::route('update/group', $group->id)->with('success',
					Lang::get('groups/message.success.create'));
			}
	...
	public function postEdit($id = null)
	{
		...
		try {
			...
			if ($group->save()) {
				...
				return Redirect::route('update/group', $id)->with('success',
					Lang::get('groups/message.success.update'));
			} else {
				// Redirect to the group page
