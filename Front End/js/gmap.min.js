$(document).ready(function(){var a=new GMaps({el:"#map",lat:38.8921021,lng:-77.0260358});a.addMarker({lat:38.8921021,lng:-77.0260358,title:"Washington"})});(function(a,b){if(typeof exports==="object"){module.exports=b()}else{if(typeof define==="function"&&define.amd){define("GMaps",[],b)}}a.GMaps=b()}(this,function(){
/*!
 * GMaps.js v0.4.17
